...
import uuid
from urllib.parse import urlencode  # Import this for query string formatting
...
def billing_info(request):
    if request.POST:
        ...
        # Get the host and create invoice number
        ...
        # Convert paypal_dict to a query string
        paypal_query_string = urlencode(paypal_dict)
        paypal_redirect_url = f"{settings.PAYPAL_URL}?{paypal_query_string}"
        ...
        # Redirect to PayPal
        return HttpResponseRedirect(paypal_redirect_url)
